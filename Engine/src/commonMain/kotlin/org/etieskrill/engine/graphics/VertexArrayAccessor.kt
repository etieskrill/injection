...
abstract class VertexArrayAccessor<T>() : BufferAccessor<T> {
    ...
    private companion object {
        private fun parseComponentType(type: KClass<*>): KClass<out Number> = when (type) {
            in listOf(Int::class, Boolean::class, Vector2i::class, Vector2ic::class,
                      Vector3i::class, Vector3ic::class, Vector4i::class, Vector4ic::class
            ) -> Int::class
            in listOf(Float::class, Vector2f::class, Vector2fc::class,
                      Vector3f::class, Vector3fc::class, Vector4f::class, Vector4fc::class
            ) -> Float::class
            in listOf(Matrix2f::class, Matrix2fc::class, Matrix3f::class, Matrix3fc::class, Matrix3x2f::class,
                      Matrix3x2fc::class, Matrix4f::class, Matrix4fc::class, Matrix4x3f::class, Matrix4x3fc::class
            ) -> Float::class
            in listOf(Double::class, Vector2d::class, Vector2dc::class,
                      Vector3d::class, Vector3dc::class, Vector4d::class, Vector4dc::class
            ) -> Double::class
            in listOf(Matrix2d::class, Matrix2dc::class, Matrix3d::class, Matrix3dc::class, Matrix3x2d::class,
        ...
        private fun parseComponentNumber(type: KClass<*>): Int = when (type) {
            in listOf(Int::class, Long::class, Boolean::class, Float::class, Double::class
            ) -> 1
            in listOf(Vector2i::class, Vector2f::class, Vector2d::class, Matrix2f::class, Matrix2d::class,
                      Vector2ic::class, Vector2fc::class, Vector2dc::class, Matrix2fc::class, Matrix2dc::class
            ) -> 2
            in listOf(Vector3i::class, Vector3f::class, Vector3d::class, Vector3ic::class, Vector3fc::class, Vector3dc::class,
            ...
            in listOf(Vector4i::class, Vector4f::class, Vector4d::class, Vector4ic::class, Vector4fc::class, Vector4dc::class,
        ...
        private fun parseMatrixRowNumber(type: KClass<*>): Int = when (type) {
            in listOf(Matrix2f::class, Matrix2d::class, Matrix3x2f::class, Matrix3x2d::class,
                      Matrix2fc::class, Matrix2dc::class, Matrix3x2fc::class, Matrix3x2dc::class
            ) -> 2
            in listOf(Matrix3f::class, Matrix3d::class, Matrix4x3f::class, Matrix4x3d::class,
                      Matrix3fc::class, Matrix3dc::class, Matrix4x3fc::class, Matrix4x3dc::class
            ) -> 3
            in listOf(Matrix4f::class, Matrix4d::class, Matrix4fc::class, Matrix4dc::class
            ) -> 4
