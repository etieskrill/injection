...
open class HBox(
    children: List<org.etieskrill.engine.scene.Node<*>>
) : org.etieskrill.engine.scene.container.Stack(children) {

    constructor(vararg children: org.etieskrill.engine.scene.Node<*>) : this(children.toList())
