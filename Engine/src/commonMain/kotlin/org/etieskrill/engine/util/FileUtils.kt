 ...
 */
val String.path get() = substringBeforeLast(separatorChar, "")
 ...
 */
val String.name get() = substringAfterLast(separatorChar)
 ...
 */
val String.extension get() = name.substringAfterLast(".", "") //TODO handle dotfiles

/**
 * File sub-extensions without path, name or primary extension.
 */
val String.subExtension
    get() = name
        .substringAfter(".", "")
