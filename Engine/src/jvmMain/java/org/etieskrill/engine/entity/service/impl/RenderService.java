...
public class RenderService implements Service, Disposable {
    ...
    private @Nullable Vector4i customViewport;
    ...
    private final @Deprecated BoundingBoxRenderService boundingBoxRenderService;
    private final @Deprecated ParticleRenderService particleRenderService;
...
//        return Set.of(DirectionalShadowMappingService.class, PointShadowMappingService.class);
    ...
    public void setCullingCamera(Camera cullingCamera) {
        this.cullingCamera = cullingCamera;
    }

    public void setCustomViewport(@Nullable Vector4i customViewport) {
    ...
    public ParticleRenderService getParticleRenderService() {
        return particleRenderService;
    }
...
class GaussBlurPostBuffers implements Disposable {
    ...
    private final HDRShader hdrShader;
    ...
    public GaussBlurPostBuffers(GraphicsContext context, Vector2ic windowSize) {
        ...
        this.frameBuffer = new FrameBuffer(context, windowSize, Map.of(
                COLOUR0, hdrBuffer,
                COLOUR1, bloomBuffer,
        ...
        this.blurFrameBuffer1 = new FrameBuffer(context, windowSize, Map.of(COLOUR0, blurTextureBuffer1));
        this.blurTextureBuffer2 = Textures.genBlank(windowSize, RGBA_F16);
        this.blurFrameBuffer2 = new FrameBuffer(context, windowSize, Map.of(COLOUR0, blurTextureBuffer2));
