        ...
        AbstractShader //i think this is the cleanest solution without moving the entire class out of the engine
{
    ...
    private static ShaderProgram missingShader;
    ...
    protected static final class ShaderFile {
        ...
        public ShaderFile(String name, ShaderType type, String source) {
            this.name = name;
            this.type = type;
            this.source = source;
        }
    ...
    public static class UniformEntry {
        ...
        public UniformEntry(String name, Uniform.Type type, boolean array, int size, @Nullable Object defaultValue) {
            this.name = name;
            this.type = type;
            this.array = array;
            this.size = size;
...
//        else cachedUniforms.put(location, value.hashCode());
    ...
    private static boolean isMissingShaderInitialised = false;

    public static ShaderProgram getMissingShader() {
        if (!isMissingShaderInitialised) {
            //FIXME potential class load deadlock (???)
            missingShader = EngineShaderLoader.INSTANCE.load("missing_shader", MissingShader::new);
            isMissingShaderInitialised = true;
        }
