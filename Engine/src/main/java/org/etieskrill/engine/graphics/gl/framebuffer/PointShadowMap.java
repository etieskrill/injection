...
public class PointShadowMap extends ShadowMap<CubeMapTexture> implements io.github.etieskrill.injection.extension.shaderreflection.ShadowMap<CubeMapTexture> {
